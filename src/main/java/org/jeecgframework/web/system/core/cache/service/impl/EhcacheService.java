package org.jeecgframework.web.system.core.cache.service.impl;
...
public class EhcacheService implements CacheService {
	...
	public void clean() {
		...
		Cache eternalCache = manager.getCache(GlobalConstants.SYSTEM_BASE_CACHE);
		Cache tagCache = manager.getCache(GlobalConstants.TAG_CACHE);
