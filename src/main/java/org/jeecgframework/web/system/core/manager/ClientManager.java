...
public class ClientManager {
	...
	private boolean addClientToCachedMap(String sessionId,Client client){
		...
		if(cacheService.get(GlobalConstants.FOREVER_CACHE, ONLINE_CLIENTS_CACHE_KEY)==null){
			onLineClients = new HashMap<String, Client>();
		}
		else{
			onLineClients =(HashMap<String, Client>) cacheService.get(GlobalConstants.FOREVER_CACHE,ONLINE_CLIENTS_CACHE_KEY);
		}
		onLineClients.put(sessionId, client);
		cacheService.put(GlobalConstants.FOREVER_CACHE,ONLINE_CLIENTS_CACHE_KEY, onLineClients);
		return true;
	}
	...
	public Collection<Client> getAllClient(){
		if(cacheService.get(GlobalConstants.FOREVER_CACHE,ONLINE_CLIENTS_CACHE_KEY)!=null){
			HashMap<String, Client> onLineClients = (HashMap<String, Client>) cacheService.get(GlobalConstants.FOREVER_CACHE,ONLINE_CLIENTS_CACHE_KEY);
