...
public class BaseUserEntity extends IdEntity implements java.io.Serializable {
    ...
    private List<UserOrgEntity> userOrgList = new ArrayList<UserOrgEntity>();
	private DepartEntity currentDepart = new DepartEntity();// 当前部门
