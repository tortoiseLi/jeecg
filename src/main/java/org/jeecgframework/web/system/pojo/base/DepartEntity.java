...
public class DepartEntity extends IdEntity implements java.io.Serializable {
	private DepartEntity TSPDepart;//上级部门
	...
	private List<DepartEntity> TSDeparts = new ArrayList<DepartEntity>();//下属部门
