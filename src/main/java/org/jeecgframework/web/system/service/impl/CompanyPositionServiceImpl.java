...
public class CompanyPositionServiceImpl extends CommonServiceImpl implements CompanyPositionService {
	 ...
	 * @return
	 */
	private void doAddBus(CompanyPositionEntity t) throws Exception{
 	}
 	/**
	 * 更新操作增强业务
	 * @param t
	 * @return
	 */
	private void doUpdateBus(CompanyPositionEntity t) throws Exception{
 	}
 	/**
	 * 删除操作增强业务
	 * @param id
	 * @return
	 */
	private void doDelBus(CompanyPositionEntity t) throws Exception{
 	}
 	
 	private Map<String,Object> populationMap(CompanyPositionEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,CompanyPositionEntity t){
