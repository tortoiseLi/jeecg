...
@Transactional
public class DictTableConfigServiceImpl extends CommonServiceImpl implements DictTableConfigService {
	...
	public boolean checkDictAuth(String dictionary, String dictCondition) {
		...
		//根据自定义字典信息查询授权配置信息
		String hql = "from DictTableConfigEntity where tableName = ? and valueCol = ? and textCol = ? and isvalid = 'Y'";
		List<DictTableConfigEntity> list = this.findHql(hql, dic[0],dic[1],dic[2]);
